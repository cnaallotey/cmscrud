    ...
    -->
        ...
        >
          ...
          >
            ...
            <h3 class="text-2xl text-gray-900 font-semibold text-center ">Add a new Client</h3>
            <div class="flex space-x-5 mt-3">
              <input
                ...
                v-model="firstName"
                @change="$emit('changeFirstName', $event.target.value)"
              />
              <input
                type="text"
                name="lastName"
                ...
                class="border p-2 w-1/2"
                v-model="lastName"
                @change="$emit('changeLastName', $event.target.value)"
              />
            </div>
            <input
              type="email"
              ...
              v-model="email"
              @change="$emit('changeEmail', $event.target.value)"
            />
            <input
              type="text"
              name="department"
              ...
              class="border p-2 w-full mt-3"
              v-model="department"
              @change="$emit('changeDepartment', $event.target.value)"
            />
            <input
              type="text"
              name="role"
