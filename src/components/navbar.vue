  ...
  <div>
    <section class="relative mx-auto">
      ...
      <nav class="flex justify-between bg-gray-900 text-white">
        <div
          class="px-5 md:px-5 xl:px-0 py-6 flex w-full items-center max-w-screen-xl mx-auto"
        >
          ...
          <div class="hidden xl:flex items-center space-x-5">
            <a
              ...
              target="_blank"
              class="flex items-center p-2 rounded-md bg-black bg-opacity-0 hover:bg-opacity-80 transition ease-out select-none delay-100"
              ><img src="../assets/github.svg" class="w-10 h-10 mr-1" alt="github" />
              <span class="font-medium text-base text-white">View Repo</span>
            </a>
            ...
            <a class="flex items-center hover:text-gray-200 hidden" href="#">
              ...
              <span class="flex absolute -mt-5 ml-4">
                <span
                  class="animate-ping absolute inline-flex h-3 w-3 rounded-full bg-yellow-400 opacity-75"
                ></span>
        ...
        <a
          class="navbar-burger self-center mr-5 xl:hidden"
          href="#"
          @click="open = !open"
        >
          <svg
          ...
          <div class="px-2 py-2 bg-white shadow dark-mode:bg-gray-800">
            ...
            <a
              ...
              ><span
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6 mr-3 hover:text-gray-200"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
